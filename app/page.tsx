          ...
          <div className="my-6">
            <div className="flex flex-col items-center">
              ...
              <TypographyP classname="w-10/12 break-normal">
                An automated and on-chain gift giving platform. Use this
                platform to create gifts that hold APT tokens that can be opened
                by the recipient on their birthday.
                <br />
                <br />
                ...
                <a
                  href="https://overmind.xyz/quests/birthday-bot"
                  target="_blank"
                >
                  <span className="underline decoration-slate-200">
                    birthday bot quest
