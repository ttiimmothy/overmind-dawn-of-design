...
export default function HistoryPage() {
  ...
  */
  ...
  const checkIfAccountExists = async () => {
    ...
    */
    ...
    if (res.statusText.includes("account_not_found")) {
  ...
  */
  const getEvents = async () => {
    ...
    */
    const responseGiftAdded = await fetch(
      // https://fullnode.testnet.aptoslabs.com/v1/accounts/0x770e0ac04e517bfe36a25e3f7cd8f303842ec9a819adb579167c9086cce74ebd/events/0x15ead142473563d1a07fae2aa04c6d38d19b33222c110a4667af357aa31439c2::birthday_bot::ModuleEvents/birthday_gift_added_events
    ...
    const eventDataGiftAdded = await responseGiftAdded.json();
    const responseGiftClaimed = await fetch(
    ...
    const eventDataGiftClaimed = await responseGiftClaimed.json();
    const responseGiftRemoved = await fetch(
    ...
    const eventDataGiftRemoved = await responseGiftRemoved.json();
    return [eventDataGiftAdded, eventDataGiftClaimed, eventDataGiftRemoved];
  };
